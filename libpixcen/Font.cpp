...
CommonFont::CommonFont(void)
{
    ...
    */
    ret = pthread_create(&thread, NULL, &CommonFont::threadentry, NULL);
    /*
    int pthread_create(pthread_t _Nullable * _Nonnull __restrict,
            const pthread_attr_t * _Nullable __restrict,
            void * _Nullable (* _Nonnull)(void * _Nullable),
...
{
    /*
     // TODO: implement wint linux mutex:
...
#endif
#ifdef __THREAD_LINUX__
void* CommonFont::threadentry(void *pParam)
#endif
{
...
void SFont::Save(nmemfile &file, LPCTSTR type)
{
	...
	if(lstrcmpi(_T("prg"),type)==0)
	{
		...
		if (n > 256)
		{
            ...
            swprintf(output, 64, L"Too many characters (%d/256)", n);
			throw (output);
		}
